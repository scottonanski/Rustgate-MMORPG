...
import { sanitizeOutput } from '../../../adapters/llm/base.ts';

// Use a relative path to the Vite proxy, which will forward requests to the actual Ollama server.
// This avoids CORS errors that happen with direct client-to-Ollama requests.
